...
<body>
                ...
                <tbody>
                    <?php
                      foreach($ret as $usuario){
                        echo "
                        <tr>
                        <td>{$usuario -> idgaleriafoto}</td>
                        <td>{$usuario -> imagem}</td>
                        <td>{$usuario -> descricao}</td>
                        <td>{$usuario -> dataEvento}</td>
                        <td>";
                        $date = date_create($usuario -> dataPostada);
                        echo date_format($date, 'd/m/Y');
                        echo "</td>
                        <td>
                            <button class='btn btn btn-warning'><a href='index.php?controle=controleUsuario&metodo=editarGaleria&idGaleria={$usuario -> idgaleriafoto}'>Visualizar</a></button>
                        </td>
                        <td>
                            <button class='btn btn btn-light'><a href='index.php?controle=controleUsuario&metodo=deletarGaleria&idGaleria={$usuario -> idgaleriafoto}'>Excluir</a></button>
                        </td>
                      </tr>
                        ";
                      }
    ...
    <footer>
        <center>
            ...
            Todos os Direitos Reservado Luciando &copy; Larissa <a href="https://projetolucianoelarissa.com"
                target="_blank">projetolucianoelarissa.com</a>

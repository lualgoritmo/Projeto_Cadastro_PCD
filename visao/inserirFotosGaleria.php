	...
	<section class="ftco-section">
		<div class="container">
			...
			<form method="POST" enctype="multipart/form-data" action="#" onsubmit="return validar(this)">
				...
				<div class="form-group">
					<label for="dataEvE">Data do Evento</label>
					<input type="date" class="form-control" name="dataEvento" value="<?php if(isset($_GET["idGaleria"])){echo $retGaleriaFotos[0]->dataEvento;}?>">
				</div>

				<div class="form-group">
					<label>Data da Postagem</label>
					<input type="date" class="form-control" name="dataPostagem" value="<?php if(isset($_GET["idGaleria"])){echo $retGaleriaFotos[0]->dataPostada;}?>">
				</div>

				<div class="form-group">
					<textarea name="descricaoImagem" class="form-control" rows="3"
					 placeholder="Descrição Da Imagem"><?php if(isset($_GET["idGaleria"])){echo $retGaleriaFotos[0]->descricao;}?></textarea>
				</div>

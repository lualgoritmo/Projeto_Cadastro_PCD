...
<html lang="pt-BR">
  ...
  <body>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>LUCIANO GARCIA DO NASCIMENTO</h3>
    ...
    <footer class="ftco-footer">
	  ...
	  Copyright &copy;<script>document.write(new Date().getFullYear());</script> Direitos <i class="fa fa-heart color-danger" aria-hidden="true"></i> by <a href="https://projetolucianoelarissa.com" target="_blank">projetolucianoelarissa.com</a>
